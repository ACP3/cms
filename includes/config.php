...
define('CONFIG_MAILER_SMTP_SECURITY', '');
define('CONFIG_MAILER_SMTP_USER', '');
define('CONFIG_MAILER_TYPE', 'mail');
define('CONFIG_MAINTENANCE_MESSAGE', 'This website is currently offline. Please try it in a few minutes again.');
