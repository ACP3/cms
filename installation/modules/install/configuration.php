...
if (isset($_POST['submit'])) {
	...
	if (isset($errors)) {
		...
		$other_arr = array(
			...
			3 => 'INSERT INTO `' . CONFIG_DB_PRE . 'menu_items` VALUES (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 1, 1, 1, 2, \'' . lang('installation', 'pages_news') . '\', \'news/list\', 1, \'\'), (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 1, 2, 3, 4, \'' . lang('installation', 'pages_files') . '\', \'files/list\', 1, \'\'), (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 1, 3, 5, 6, \'' . lang('installation', 'pages_gallery') . '\', \'gallery/list\', 1, \'\'), (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 1, 4, 7, 8, \'' . lang('installation', 'pages_guestbook') . '\', \'guestbook/list\', 1, \'\'), (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 1, 5, 9, 10, \'' . lang('installation', 'pages_polls') . '\', \'polls/list\', 1, \'\'), (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 1, 6, 11, 12, \'' . lang('installation', 'pages_search') . '\', \'search/list\', 1, \'\'), (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 2, 7, 13, 14, \'' . lang('installation', 'pages_contact') . '\', \'contact/list\', 1, \'\'), (\'\', \'' . $current_date . '\', \'' . $current_date . '\', 2, 2, 8, 15, 16, \'' . lang('installation', 'pages_imprint') . '\', \'contact/imprint\', 1, \'\')',
