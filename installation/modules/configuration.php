...
if (isset($_POST['submit'])) {
	...
	if (isset($errors)) {
		...
		$other_arr = array(
			...
			2 => 'INSERT INTO `' . $db->prefix . 'news` VALUES (\'\', \'' . $current_date . '\', \'' . $current_date . '\', \'' . $lang->t('installation', 'news_headline_alias') . '\', \'' . $lang->t('installation', 'news_text') . '\', \'1\', \'1\', \'1\', \'\', \'\', \'\')',
			...
			5 => 'INSERT INTO `' . $db->prefix . 'aliases` VALUES (\'' . $lang->t('installation', 'news_headline_alias') . '\', \'news/details/id_1/\')',
			6 => 'INSERT INTO `' . $db->prefix . 'aliases` VALUES (\'' . $lang->t('installation', 'pages_imprint_alias') . '\', \'contact/imprint/\')',
		);
