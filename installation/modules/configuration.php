...
if (isset($_POST['submit'])) {
	...
	if (isset($errors)) {
		...
		$other_arr = array(
			1 => 'INSERT INTO `' . $db->prefix . 'users` VALUES (\'\', \'' . $db->escape($form['user_name']) . '\', \'' . sha1($salt . sha1($form['user_pwd'])) . ':' . $salt . '\', 1, \'0\', \':1\', \'1:1\', \':1\', \'1\', \'' . $form['mail'] . ':1\', \':1\', \':1\', \':1\', \':1\', \'' . CONFIG_DATE_TIME_ZONE . '\', \'' . CONFIG_DST .'\', \'' . CONFIG_LANG . '\', \'\')',
