...
if (!isset($entries)) {
	...
	view::setContent(confirmBox($lang->t('common', 'confirm_delete'), $uri->route('acp/newsletter/delete/entries_' . $marked_entries . '/action_confirmed/'), $uri->route('acp/newsletter')));
	...
	setRedirectMessage($bool !== null ? $lang->t('common', 'delete_success') : $lang->t('common', 'delete_error'), 'acp/newsletter');
} else {
