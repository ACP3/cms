<form action="{uri args="acp/menu_items/delete_blocks"}" method="post">
	<div id="adm-list">
		{check_access mode="link" uri="acp/menu_items/create_block" icon="32/source_moc" width="32" height="32"}
		{check_access mode="input" action="menu_items|acp_delete_blocks" icon="32/cancel" lang="common|delete_marked"}
...
{/if}
				<td>{check_access mode="link" uri="acp/menu_items/edit_block/id_`$row.id`" title=$row.title}</td>
