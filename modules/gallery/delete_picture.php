...
if (!isset($entries)) {
	...
	$content = comboBox($lang->t('common', 'confirm_delete'), uri('acp/gallery/delete_picture/entries_' . $marked_entries . '/action_confirmed/'), uri('acp/gallery/edit_gallery/id_' . $uri->id));
