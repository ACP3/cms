...
class Modules
{
	...
	{
		return \ACP3\CMS::$injector['Db']->fetchColumn('SELECT COUNT(*) FROM ' . DB_PRE . 'modules WHERE name = ?', array($module)) == 1 ? true : false;
	}
	/**
	...
	public static function getModuleInfo($module)
	{
		...
		if (empty($parsed_modules)) {
			$filename = 'infos_' . \ACP3\CMS::$injector['Lang']->getLanguage();
	...
	public static function setModulesCache()
	{
		...
		Cache::create('infos_' . \ACP3\CMS::$injector['Lang']->getLanguage(), $infos, 'modules');
	}
}