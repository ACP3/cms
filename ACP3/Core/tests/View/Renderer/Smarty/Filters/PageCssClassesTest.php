...
class PageCssClassesTest extends AbstractPluginTestCase
{
    /**
     * @var PageCssClasses
     */
    ...
    public static function processDataProvider(): array
    {
        return [
            ...
            'with-existing-class-attribute' => [
                ...
                self::getTemplateOutputWithExistingClassAttribute(),
                1,
                false,
                AreaEnum::AREA_FRONTEND,
            ],
...
HTML;
    ...
    private static function getTemplateOutput(): string
    {
        return <<<HTML
<!DOCTYPE html>
<html>
...
HTML;
    ...
    private static function getTemplateOutputWithExistingClassAttribute(): string
    {
        return str_replace(self::getTemplateOutput(), '<body>', '<body class="already-exists">');
    }
}
