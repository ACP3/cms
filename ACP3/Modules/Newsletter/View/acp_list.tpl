        ...
        <table id="acp-table" class="table table-striped table-hover">
            ...
            {foreach $newsletter as $row}
                <tr>
                    ...
                    {if $can_send}
                        <td>
                            <a href="{uri args="acp/newsletter/send/id_`$row.id`"}" title="{lang t="newsletter|acp_send"}">{icon path="16/mail_send" width="16" height="16" alt="{lang t="newsletter|send"}"}</a>
                        </td>
                    {/if}
                    <td>{$row.id}</td>
                </tr>
