...
class CategoriesAdmin extends Core\ModuleController {
	...
	public function actionDelete() {
		...
		if (!isset($entries)) {
			...
			$this->injector['View']->setContent(confirmBox($this->injector['Lang']->t('system', 'confirm_delete'), $this->injector['URI']->route('acp/categories/delete/entries_' . $marked_entries . '/action_confirmed/'), $this->injector['URI']->route('acp/categories')));
