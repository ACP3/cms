...
{include file="asset:Menus/Partials/form_group.parent_menu_item.tpl" name="parent_id" menuItems=$menuItems required=true label={lang t="menus|superior_page"} emptyOptionLabel={lang t="menus|no_superior_page"}}
