...
{block CONTENT_AJAX_FORM}
    {block PERMISSIONS_RESOURCES_MODULE}
        <div class="form-group row">
            <label for="modules" class="col-sm-2 col-form-label required">{lang t="system|module"}</label>
    ...
    <div class="form-group row">
        <label for="privileges" class="col-sm-2 col-form-label required">{lang t="permissions|assigned_privilege"}</label>
