...
{block CONTENT_AJAX_FORM}
    ...
    {block CATEGORIES_MODULE}
        <div class="form-group row">
            <label for="module-id" class="col-sm-2 col-form-label required">{lang t="categories|module"}</label>
    ...
    {if !empty($category_tree)}
        <div class="form-group row">
            <label for="parent-id" class="col-sm-2 col-form-label">{lang t="categories|superior_category"}</label>
            <div class="col-sm-10">
