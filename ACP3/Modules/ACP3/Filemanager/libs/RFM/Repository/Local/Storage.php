...
class Storage extends BaseStorage
{
    ...
    protected function setDefaults()
    {
        ...
        if ($fileRoot !== false) {
            ...
            $this->documentRoot = $_SERVER['DOCUMENT_ROOT'];
            $this->storageRoot = \dirname($_SERVER['SCRIPT_FILENAME'], 3) . '/' . $this->defaultDir;
        }
     ...
     */
    public function setRoot(string $path, bool $makeDir = false, bool $relativeToDocumentRoot = false): void
    {
     ...
     * @param bool   $includeFolder If true includes the source folder also
     *
     * @return bool
     *
     ...
     */
    public function getDirSummary(string $dir, array &$result = ['size' => 0, 'files' => 0, 'folders' => 0]): array
    {
