...
class ItemModel extends BaseItemModel
{
     ...
     *
     * @see http://stackoverflow.com/questions/22312833/how-can-you-tell-if-an-object-is-a-folder-on-aws-s3
     */
     ...
     * @return self|null
     */
    public function closest(): ?ItemModelInterface
    {
     ...
     * @return self|null
     */
    public function thumbnail(): ?ItemModelInterface
    {
    ...
    public function getAclPermissions()
    {
        if ($this->isThumbnail && $this->storage->config('images.thumbnail.useLocalStorage')) {
            throw new \Exception('Trying to get ACL policies for non S3 object.');
        }
