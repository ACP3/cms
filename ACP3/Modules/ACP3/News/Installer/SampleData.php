...
class SampleData extends AbstractSampleData
{
    ...
    public function sampleData()
    {
        ...
        return [
            ...
            "INSERT INTO `{pre}news` VALUES (1, 1, '{$currentDate}', '{$currentDate}', '{$currentDate}', '{$translator->t('news', 'sample_data_news_headline')}', '{$translator->t('news', 'sample_data_news_text')}', 1, 1, 1, '', 1, '', 1);",
        ];
    }
}
