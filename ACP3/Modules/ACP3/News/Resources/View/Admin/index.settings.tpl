...
{block CONTENT_AJAX_FORM}
    ...
    {include file="asset:System/Partials/form_group.input_number.tpl" name="readmore_chars" value=$readmore_chars required=true label={lang t="news|readmore_chars"}}
