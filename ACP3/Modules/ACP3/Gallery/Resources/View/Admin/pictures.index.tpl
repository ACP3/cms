...
{block HEADER_BAR}
    {check_access mode="link" path="acp/gallery/pictures/create/id_`$gallery_id`" class="fas fa-plus" btn_class="btn btn-primary" title={lang t="gallery|admin_pictures_create"}}
{/block}
