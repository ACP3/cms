...
export function highlightAllTableRows(markAllRowsCheckboxElem, action) {
    jQuery(markAllRowsCheckboxElem)
        .closest('table')
        .find('tr:has(td :checkbox)')
...
function setMarkAllCheckboxState(markAllRowsCheckboxElem, checkboxName) {
    ...
    markAllRowsCheckboxElem.indeterminate = visibleSelectedTableRows > 0 && visibleMassActionCheckboxes !== visibleSelectedTableRows;
    markAllRowsCheckboxElem.checked = visibleSelectedTableRows > 0 && visibleMassActionCheckboxes === visibleSelectedTableRows;
}
...
export function deleteMarkedResults(elem, options) {
    ...
    $this.on('click', function (e) {
        ...
        if ($selectedMassActionCheckboxes.length > 0) {
            const confirmationText = $selectedMassActionCheckboxes.length === 1
