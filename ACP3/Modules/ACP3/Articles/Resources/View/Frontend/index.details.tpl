    ...
    {if !empty($page.next) || !empty($page.previous)}
        ...
        <div class="row no-gutters">
            {if !empty($page.previous)}
                <div class="col">
                    <a href="{$page.previous}" rel="prev" class="btn btn-sm btn-outline-primary">&laquo; {lang t="system|previous_page"}</a>
                </div>
            {/if}
            {if !empty($page.next)}
                <div class="col text-right">
                    <a href="{$page.next}" rel="next" class="btn btn-sm btn-outline-primary">{lang t="system|next_page"} &raquo;</a>
                </div>
            {/if}
        </div>
    {/if}
