...
{block HEADER_BAR_OPTIONS}
    {check_access mode="link" path="users/account/edit" iconSet="solid" icon="edit" class="text-info"}
    {check_access mode="link" path="users/account/settings" iconSet="solid" icon="cog"}
