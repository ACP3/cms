...
{block CONTENT_AJAX_FORM}
    <ul class="nav nav-tabs mb-3">
        ...
        <li class="nav-item"><a href="#tab-5" class="nav-link" data-toggle="tab">{lang t="users|privacy"}</a></li>
        <li class="nav-item"><a href="#tab-6" class="nav-link" data-toggle="tab">{lang t="users|pwd"}</a></li>
    </ul>
