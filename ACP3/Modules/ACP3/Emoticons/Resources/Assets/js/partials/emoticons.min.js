...
d.click(function(a){a.preventDefault();var d=c.val(),e=d.substr(0,b),f=d.substr(b);b+=$(this).attr("title").length+2,c.val(e+" "+$(this).attr("title")+" "+f).focus().setCaretPosition(b)}),c.blur(function(){b=c.getCaretPosition()})},function(a){a(".icons a").insertEmoticon(a(".icons").data("emoticons-input"))}(jQuery);
