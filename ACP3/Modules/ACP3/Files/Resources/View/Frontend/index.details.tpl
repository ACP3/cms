...
{block EDIT_CONTENT}
    {include file="asset:System/Partials/ajax-modal-edit.tpl" modal=['acl_resource' => 'admin/files/index/edit', 'edit_path' => "acp/files/index/edit/id_`$file.id`/", 'id' => 'js-edit-files', 'title' => {lang t="files|admin_index_edit"}]}
{/block}
