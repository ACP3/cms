...
{
    public function __construct(private readonly DataGrid $dataGrid, private readonly CommentsByModuleDataGridRepository $dataGridRepository, private readonly ResultsPerPage $resultsPerPage, private readonly Translator $translator)
    {
    }
