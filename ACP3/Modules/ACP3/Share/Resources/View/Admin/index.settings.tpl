...
{block CONTENT_AJAX_FORM}
    ...
    <div id="fb-credentials-wrapper">
        {include file="asset:System/Partials/form_group.input_text.tpl" name="fb_app_id" value=$form.fb_app_id maxlength=255 labelRequired=true label={lang t="share|fb_app_id"}}
        {include file="asset:System/Partials/form_group.input_password.tpl" name="fb_secret" value=$form.fb_secret maxlength=255 labelRequired=true label={lang t="share|fb_secret"}}
    </div>
