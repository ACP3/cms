        ...
        <nav id="adm-list" class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex2-collapse">
                <div class="navbar-text pull-right">
                    {check_access mode="link" path="acp/polls/index/create" icon="32/kchart" width="32" height="32"}
                    {check_access mode="input" path="acp/polls/index/delete" icon="32/cancel" lang="system|delete_marked"}
                </div>
            </div>
        </nav>
        {redirect_message}
