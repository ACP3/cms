<div class="form-group">
    <label for="alias" class="col-sm-2 control-label">{lang t="system|seo_uri_alias"}</label>
...
<div class="form-group">
    <label for="seo-keywords" class="col-sm-2 control-label">{lang t="system|seo_keywords"}</label>
...
<div class="form-group">
    <label for="seo-description" class="col-sm-2 control-label">{lang t="system|seo_description"}</label>
...
<div class="form-group">
    <label for="seo-robots" class="col-sm-2 control-label">{lang t="system|seo_robots"}</label>
