...
<div id="page-break-form" class="modal hide">
	...
	<div class="modal-body form-horizontal">
		<div class="control-group">
			<label for="toc-title" class="control-label">{lang t="system|title_for_toc"}</label>
			<div class="controls"><input type="text" id="toc-title"></div>
		</div>
		<div class="form-actions"><button class="btn">{lang t="system|submit"}</button></div>
	</div>
</div>
<div id="page-break-link" class="align-left"><a href="#" class="btn">{lang t="system|insert_page_break"}</a></div>
