                    ...
                    <td class="sub-table-header" colspan="{$colspan}">
                        ...
                        {if $can_delete || $can_edit}
                            <div class="btn-group pull-right">
                                {if $can_edit}
                                    <a href="{uri args="acp/menus/edit/id_`$values.menu_id`"}" class="btn btn-default btn-sm" title="{lang t="menus|acp_edit"}"><i class="glyphicon glyphicon-edit"></i> {lang t="system|edit"}
                                    </a>
                                {/if}
                                {if $can_delete}
                                    <a href="{uri args="acp/menus/delete/entries_`$values.menu_id`"}" class="btn btn-default btn-sm" title="{lang t="menus|acp_delete"}"><i class="glyphicon glyphicon-remove"></i> {lang t="system|delete"}
                                    </a>
                                {/if}
                            </div>
                        {/if}
