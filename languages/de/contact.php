...
define('contact_address', 'Anschrift');
define('contact_address_to_short', 'Die Anschrift sollte mindestens 3 Zeichen lang sein');
define('contact_contact', 'Kontakt');
...
define('contact_form_success', 'Die E-Mail wurde erfolgreich versendet. Wir werden uns in Kürze mit Ihnen in Verbindung setzen.');
...
define('contact_disclaimer_to_short', 'Die Haftungshinweise sollten mindestens 3 Zeichen lang sein');
define('contact_fax', 'FAX Nummer');
define('contact_imprint', 'Impressum');
...
define('contact_powered_by', 'Diese Webseite wird angetrieben vom %s');
