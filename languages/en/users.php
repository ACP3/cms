...
define('users_forgot_pwd_error', 'While sending the E-mail with you new password an error has occured.');
...
define('users_user_already_exists', 'There is already an user account with the same username');
