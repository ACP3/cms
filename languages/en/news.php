...
define('news_headline_to_short', 'The headline should be at least 3 characters long');
define('news_link_title', 'Link title');
define('news_mod_description', 'With this module you can adminster the news.');
define('news_news', 'News');
define('news_news_overview', 'News overview');
define('news_read_newsfeed', 'Read newsfeed');
define('news_read_on', 'read on');
define('news_select_category', 'Please select the category, where do you want to find the news');
define('news_target_page', 'Target page');
define('news_text', 'Text');
define('news_text_to_short', 'The newstext should be at least 3 characters long');
define('news_uri', 'URI');
define('news_window_blank', 'New window (_blank)');
define('news_window_self', 'Same window (_self)');
?>