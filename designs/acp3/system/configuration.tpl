...
{/foreach}
				...
				<dd><input type="number" name="form[flood]" id="flood" value="{$form.flood}"></dd>
				<dt>
...
{/foreach}
		...
		<div id="tab-6" class="ui-tabs-hide">
			<dl>
				...
				<dd>
					<select name="form[mailer_type]" id="mailer-type">
...
{/foreach}
			...
			<dl id="mailer-smtp-1">
				...
				<dd><input type="text" name="form[mailer_smtp_host]" id="mailer-smtp-host" value="{$form.mailer_smtp_host}"></dd>
				<dt><label for="mailer-smtp-port">{lang t="system|mailer_smtp_port"}</label></dt>
				<dd><input type="number" name="form[mailer_smtp_port]" id="mailer-smtp-port" value="{$form.mailer_smtp_port}"></dd>
				<dt><label for="mailer-smtp-security">{lang t="system|mailer_smtp_security"}</label></dt>
				<dd>
					<select name="form[mailer_smtp_security]" id="mailer-smtp-security">
...
{foreach $mailer_smtp_auth as $row}
					<label for="mailer-smtp-auth-{$row.value}">
						<input type="radio" name="form[mailer_smtp_auth]" id="mailer-smtp-auth-{$row.value}" value="{$row.value}" class="checkbox"{$row.checked}>
						{$row.lang}
					</label>
{/foreach}
				</dd>
			...
			<dl id="mailer-smtp-2">
				...
				<dd><input type="text" name="form[mailer_smtp_user]" id="mailer-smtp-user" value="{$form.mailer_smtp_user}" maxlength="40"></dd>
				<dt><label for="mailer-smtp-password">{lang t="system|mailer_smtp_password"}</label></dt>
				<dd><input type="password" name="form[mailer_smtp_password]" id="mailer-smtp-password" value="{$form.mailer_smtp_password}"></dd>
			</dl>
		</div>
	</div>
