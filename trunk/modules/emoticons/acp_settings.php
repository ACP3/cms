...
if (isset($_POST['submit']) === true) {
	...
	if (isset($errors) === true) {
		...
		$bool = ACP3_Config::setSettings('emoticons', $_POST);

		ACP3_CMS::$session->unsetFormToken();

		setRedirectMessage($bool, ACP3_CMS::$lang->t('common', $bool === true ? 'settings_success' : 'settings_error'), 'acp/emoticons');
	}
}
if (isset($_POST['submit']) === false || isset($errors) === true && is_array($errors) === true) {
	...
	ACP3_CMS::setContent(ACP3_CMS::$view->fetchTemplate('emoticons/acp_settings.tpl'));
}
