...
{/foreach}
			...
			<div id="tab-5" class="tab-pane">
				<div class="control-group">
					<label for="{$mail_display.0.id}" class="control-label">{lang t="users|display_mail"}</label>
					<div class="controls">
						<div class="btn-group" data-toggle="radio">
...
{/foreach}
				...
				<div class="control-group">
					<label for="{$address_display.0.id}" class="control-label">{lang t="users|display_address"}</label>
					<div class="controls">
						<div class="btn-group" data-toggle="radio">
...
{/foreach}
				...
				<div class="control-group">
					<label for="{$country_display.0.id}" class="control-label">{lang t="users|display_country"}</label>
					<div class="controls">
						<div class="btn-group" data-toggle="radio">
...
{/foreach}
				...
				<div class="control-group">
					<label for="{$birthday_display.0.id}" class="control-label">{lang t="users|birthday"}</label>
					<div class="controls">
