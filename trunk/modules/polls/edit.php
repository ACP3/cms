...
if (validate::isNumber($uri->id) && $db->select('COUNT(id)', 'poll_question', 'id = \'' . $uri->id . '\'', 0, 0, 0, 1) == '1') {
	if (isset($_POST['submit'])) {
		...
		if (isset($errors)) {
			...
			$content = comboBox($bool ? $lang->t('common', 'edit_success') : $lang->t('common', 'edit_error'), uri('acp/polls'));
		}
	}
