<form action="{uri args="acp/categories/delete"}" method="post">
	<div id="adm-list">
		{check_access mode="link" uri="acp/categories/create" icon="32/folder_new" width="32" height="32"}
		{check_access mode="link" uri="acp/categories/settings" icon="32/advancedsettings" width="32" height="32"}
		{check_access mode="input" action="categories|acp_delete" icon="32/cancel" lang="common|delete_marked"}
...
{/if}
				<td>{check_access mode="link" uri="acp/categories/edit/id_`$row.id`" title=$row.name}</td>
