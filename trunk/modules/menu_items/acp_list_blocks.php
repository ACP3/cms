...
$breadcrumb->append($lang->t('menu_items', 'acp_list_blocks'));
...
if ($c_blocks > 0) {
	...
	$tpl->assign('can_delete', ACP3_Modules::check('menu_items', 'acp_delete_blocks'));
}

ACP3_View::setContent(ACP3_View::fetchTemplate('menu_items/acp_list_blocks.tpl'));
