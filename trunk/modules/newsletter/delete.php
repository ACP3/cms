...
if (!isset($entries)) {
	...
	view::setContent(comboBox($lang->t('common', 'confirm_delete'), $uri->route('acp/newsletter/delete/entries_' . $marked_entries . '/action_confirmed/'), $uri->route('acp/newsletter')));
	...
	view::setContent(comboBox($bool !== null ? $lang->t('common', 'delete_success') : $lang->t('common', 'delete_error'), $uri->route('acp/newsletter')));
} else {
