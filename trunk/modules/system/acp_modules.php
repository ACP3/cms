...
foreach ($mod_list as $name => $info) {
	if ($info['protected']) {
		...
		$mod_list[$name]['action'] = '<a href="' . uri('system/entry/action_acp_moddeactivation/dir_' . $info['dir']) . '" title="' . lang('system', 'disable_module') . '"><img src="' . ROOT_DIR . 'images/crystal/16/active.png" alt="" /></a>';
	} else {
		$mod_list[$name]['action'] = '<a href="' . uri('system/entry/action_acp_modactivation/dir_' . $info['dir']) . '" title="' . lang('system', 'enable_module') . '"><img src="' . ROOT_DIR . 'images/crystal/16/inactive.png" alt="" /></a>';
	}
