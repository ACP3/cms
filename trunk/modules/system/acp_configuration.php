...
if (isset($_POST['submit']) === true) {
	...
	if (ACP3_Validate::timeZone($_POST['date_time_zone']) === false)
		$errors['date-time-zone'] = ACP3_CMS::$lang->t('common', 'select_time_zone');
	...
	if (isset($errors) === true) {
		...
		$config = array(
			...
			'extra_css' => ACP3_CMS::$db->escape($_POST['extra_css'], 2),
			'extra_js' => ACP3_CMS::$db->escape($_POST['extra_js'], 2),
			...
			'maintenance_message' => ACP3_CMS::$db->escape($_POST['maintenance_message']),
			'maintenance_mode' => (int) $_POST['maintenance_mode'],
			'seo_aliases' => (int) $_POST['seo_aliases'],
			'seo_meta_description' => ACP3_CMS::$db->escape($_POST['seo_meta_description']),
			'seo_meta_keywords' => ACP3_CMS::$db->escape($_POST['seo_meta_keywords']),
			'seo_mod_rewrite' => (int) $_POST['seo_mod_rewrite'],
			'seo_robots' => (int) $_POST['seo_robots'],
			'seo_title' => ACP3_CMS::$db->escape($_POST['seo_title']),
		...
		ACP3_CMS::setContent(confirmBox($bool === true ? ACP3_CMS::$lang->t('system', 'config_edit_success') : ACP3_CMS::$lang->t('system', 'config_edit_error'), ACP3_CMS::$uri->route('acp/system/configuration')));
	}
}
if (isset($_POST['submit']) === false || isset($errors) === true && is_array($errors) === true) {
	...
	$robots[0]['lang'] = ACP3_CMS::$lang->t('common', 'seo_robots_index_follow');
	$robots[1]['value'] = '2';
	$robots[1]['selected'] = selectEntry('seo_robots', '2', CONFIG_SEO_ROBOTS);
	$robots[1]['lang'] = ACP3_CMS::$lang->t('common', 'seo_robots_index_nofollow');
	$robots[2]['value'] = '3';
	$robots[2]['selected'] = selectEntry('seo_robots', '3', CONFIG_SEO_ROBOTS);
	$robots[2]['lang'] = ACP3_CMS::$lang->t('common', 'seo_robots_noindex_follow');
	$robots[3]['value'] = '4';
	$robots[3]['selected'] = selectEntry('seo_robots', '4', CONFIG_SEO_ROBOTS);
	$robots[3]['lang'] = ACP3_CMS::$lang->t('common', 'seo_robots_noindex_nofollow');
	...
	$aliases[0]['lang'] = ACP3_CMS::$lang->t('common', 'yes');
	$aliases[1]['value'] = '0';
	$aliases[1]['checked'] = selectEntry('seo_aliases', '0', CONFIG_SEO_ALIASES, 'checked');
	$aliases[1]['lang'] = ACP3_CMS::$lang->t('common', 'no');
