...
define('polls_per_cent', 'Prozent');
define('polls_poll', 'Umfrage');
define('polls_poll_error', 'Beim Speichern Ihrer Stimme ist ein Fehler aufgetreten.');
define('polls_poll_success', 'Ihre Stimme wurde erfolgreich gezählt.');
define('polls_polls', 'Umfragen');
define('polls_polls_archive', 'Umfragen Archiv');
define('polls_polls_overview', 'Umfragen Übersicht');
define('polls_question', 'Frage');
define('polls_result', 'Ergebnis');
define('polls_total_votes', 'Gesamt');
define('polls_type_in_answer', 'Bitte geben Sie zumindest eine Antwort ein');
define('polls_type_in_question', 'Bitte geben Sie eine Frage ein');
define('polls_vote', 'Abstimmen');
