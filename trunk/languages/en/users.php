...
define('users_type_in_name_and_email', 'Please either enter the E-mail address or the user name you used with the registration');
define('users_type_in_pwd', 'Either the password is empty or there is a typo in the repetition');
define('users_user_already_exists', 'There is already an user account registered with the same username');
