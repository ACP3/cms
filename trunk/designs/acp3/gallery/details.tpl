...
{if isset($picture_next)}
	<a href="{uri args="gallery/details/id_`$picture_next.id`"}"><img src="{uri args="gallery/image/id_`$picture.id`/action_normal"}" alt=""></a>
{else}
...
{/if}
		<a href="{uri args="gallery/pics/id_`$picture.gallery_id`"}">{lang t="gallery|picture_index"}</a>
{if isset($picture_next)}
