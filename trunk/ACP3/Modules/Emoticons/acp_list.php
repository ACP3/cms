...
$emoticons = ACP3\CMS::$injector['Db']->fetchAll('SELECT id, code, description, img FROM ' . DB_PRE . 'emoticons ORDER BY id DESC');
$c_emoticons = count($emoticons);

if ($c_emoticons > 0) {
	$can_delete = ACP3\Core\Modules::check('emoticons', 'acp_delete');
	$config = array(
		'element' => '#acp-table',
