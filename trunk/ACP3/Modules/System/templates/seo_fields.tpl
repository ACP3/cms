...
<div class="control-group">
	<label for="alias" class="control-label">{lang t="system|seo_uri_alias"}</label>
	<div class="controls">
...
{/if}
<div class="control-group">
	<label for="seo-keywords" class="control-label">{lang t="system|seo_keywords"}</label>
	<div class="controls">
...
<div class="control-group">
	<label for="seo-description" class="control-label">{lang t="system|seo_description"}</label>
	<div class="controls">
