...
<form action="{$REQUEST_URI}" method="post" accept-charset="UTF-8" class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-lg-10"><input class="form-control" type="text" name="name" id="name" size="35" value="{$form.name}" required{$form.name_disabled}></div>
	</div>
	<div class="form-group">
		<label for="mail" class="col-lg-2 control-label">{lang t="system|email_address"}</label>
		<div class="col-lg-10"><input class="form-control" type="email" name="mail" id="mail" size="35" value="{$form.mail}"{$form.mail_disabled}></div>
	</div>
	<div class="form-group">
		<label for="website" class="col-lg-2 control-label">{lang t="system|website"}</label>
		<div class="col-lg-10"><input class="form-control" type="url" name="website" id="website" size="35" value="{$form.website}"{$form.website_disabled}></div>
	</div>
	<div class="form-group">
