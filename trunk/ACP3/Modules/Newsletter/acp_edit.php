...
if (ACP3\Core\Validate::isNumber(ACP3\CMS::$injector['URI']->id) === true &&
	...
	->append(ACP3\CMS::$injector['Lang']->t('newsletter', 'newsletter'), ACP3\CMS::$injector['URI']->route('acp/newsletter'))
	->append(ACP3\CMS::$injector['Lang']->t('newsletter', 'acp_edit'));
	...
	if (isset($_POST['submit']) === true) {
		...
		if (isset($errors) === true) {
			...
			$bool = ACP3\CMS::$injector['Db']->update(DB_PRE . 'newsletters', $update_values, array('id' => ACP3\CMS::$injector['URI']->id));
	...
	if (isset($_POST['submit']) === false || isset($errors) === true && is_array($errors) === true) {
		...
		ACP3\CMS::$injector['View']->assign('form', isset($_POST['submit']) ? $_POST : $newsletter);
