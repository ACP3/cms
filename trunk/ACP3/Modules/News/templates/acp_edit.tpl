		...
		<div class="tab-content">
			...
			<div id="tab-2" class="tab-pane">
				<div class="form-group">
					...
					<div class="col-lg-10"><input class="form-control" type="text" name="title" id="title" value="{$form.title}" maxlength="120"></div>
				</div>
				<div class="form-group">
			...
			<div id="tab-3" class="tab-pane">
				<div class="form-group">
					...
					<div class="col-lg-10"><input class="form-control" type="text" name="link_title" id="link-title" value="{$form.link_title}" maxlength="120"></div>
				</div>
				<div class="form-group">
					<label for="uri" class="col-lg-2 control-label">{lang t="news|uri"}</label>
					<div class="col-lg-10"><input class="form-control" type="url" name="uri" id="uri" value="{$form.uri}" maxlength="120"></div>
				</div>
				<div class="form-group">
