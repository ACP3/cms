...
class Model extends Core\Model
{
    ...
    {
        return $this->db->fetchAll('SELECT n.*, c.title AS cat FROM ' . $this->db->getPrefix() . static::TABLE_NAME . ' AS n, ' . $this->db->getPrefix() . \ACP3\Modules\Categories\Model::TABLE_NAME . ' AS c WHERE n.category_id = c.id ORDER BY n.start DESC, n.end DESC, n.id DESC');
    }
