...
<form action="{uri args="acp/contact"}" method="post" accept-charset="UTF-8" class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-lg-10"><input class="form-control" type="email" name="mail" id="mail" value="{$form.mail}" maxlength="120"></div>
	</div>
	<div class="form-group">
		<label for="telephone" class="col-lg-2 control-label">{lang t="contact|telephone"}</label>
		<div class="col-lg-10"><input class="form-control" type="tel" name="telephone" id="telephone" value="{$form.telephone}" maxlength="120"></div>
	</div>
	<div class="form-group">
		<label for="fax" class="col-lg-2 control-label">{lang t="contact|fax"}</label>
		<div class="col-lg-10"><input class="form-control" type="tel" name="fax" id="fax" value="{$form.fax}" maxlength="120"></div>
	</div>
	<div class="form-group">
