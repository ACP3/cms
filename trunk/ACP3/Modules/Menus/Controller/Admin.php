    ...
    public function actionEditItem()
    {
        if (Core\Validate::isNumber($this->uri->id) === true &&
            ...
            if (isset($_POST['submit']) === false || isset($errors) === true && is_array($errors) === true) {
                ...
                // Block
                $this->view->assign('blocks', Menus\Helpers::menusDropdown($page['block_id']));
                ...
                // Daten an Smarty übergeben
                $this->view->assign('pages_list', Menus\Helpers::menuItemsList($page['parent_id'], $page['left_id'], $page['right_id']));
