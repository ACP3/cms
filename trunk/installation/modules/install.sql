...
INSERT INTO `{pre}settings` VALUES ('', 'categories', 'width', '100');
INSERT INTO `{pre}settings` VALUES ('', 'categories', 'height', '50'), ('', 'categories', 'filesize', '40960');
INSERT INTO `{pre}settings` VALUES ('', 'comments', 'dateformat', 'long'), ('', 'comments', 'emoticons', '1');
INSERT INTO `{pre}settings` VALUES ('', 'contact', 'mail', ''), ('', 'contact', 'address', ''), ('', 'contact', 'telephone', ''), ('', 'contact', 'fax', ''), ('', 'contact', 'disclaimer', ''), ('', 'contact', 'layout', '<div class="imprint"><dl><dt>{address_lang}</dt><dd>{address_value}</dd></dl><dl><dt>{email_lang}</dt><dd>{email_value}</dd></dl><dl><dt>{telephone_lang}</dt><dd>{telephone_value}</dd></dl><dl><dt>{fax_lang}</dt><dd>{fax_value}</dd></dl><dl><dt>{disclaimer_lang}</dt><dd>{disclaimer_value}</dd></dl></div>');
INSERT INTO `{pre}settings` VALUES ('', 'emoticons', 'width', '32'), ('', 'emoticons', 'height', '32'), ('', 'emoticons', 'filesize', '10240');
INSERT INTO `{pre}settings` VALUES ('', 'files', 'comments', '1'), ('', 'files', 'dateformat', 'long'), ('', 'files', 'sidebar', '5');
INSERT INTO `{pre}settings` VALUES ('', 'gallery', 'width', '640'), ('', 'gallery', 'height', '480'), ('', 'gallery', 'thumbwidth', '160'), ('', 'gallery', 'thumbheight', '120'), ('', 'gallery', 'maxwidth', '1024'), ('', 'gallery', 'maxheight', '768'), ('', 'gallery', 'filesize', '20971520'), ('', 'gallery', 'overlay', '1'), ('', 'gallery', 'comments', '1'), ('', 'gallery', 'dateformat', 'long'), ('', 'gallery', 'sidebar', '5');
INSERT INTO `{pre}settings` VALUES ('', 'guestbook', 'dateformat', 'long'), ('', 'guestbook', 'notify', '0'), ('', 'guestbook', 'notify_email', ''), ('', 'guestbook', 'emoticons', '1'), ('', 'guestbook', 'newsletter_integration', '0'), ('', 'guestbook', 'overlay', '1');
INSERT INTO `{pre}settings` VALUES ('', 'news', 'comments', '1'), ('', 'news', 'dateformat', 'long'), ('', 'news', 'readmore', '1'), ('', 'news', 'readmore_chars', '350'), ('', 'news', 'sidebar', '5'), ('', 'news', 'category_in_breadcrumb', '1');
INSERT INTO `{pre}settings` VALUES ('', 'newsletter', 'mail', ''), ('', 'newsletter', 'mailsig', '');
