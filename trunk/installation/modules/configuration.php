...
if (isset($_POST['submit'])) {
	...
	if (isset($errors)) {
		...
		$other_arr = array(
			...
			5 => 'INSERT INTO `' . $db->prefix . 'aliases` VALUES (\'news/details/id_1/\', \'' . $lang->t('installation', 'news_headline_alias') . '\')',
			6 => 'INSERT INTO `' . $db->prefix . 'aliases` VALUES (\'contact/imprint/\', \'' . $lang->t('installation', 'pages_imprint_alias') . '\')',
		);
